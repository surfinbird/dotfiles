...
install_packages() {
    ...
    apt_dep=(build-essential zsh emacs tmux vim i3 i3blocks suckless-tools tig fonts-font-awesome lxappearance gtk-chteme)
    # lxappearance gtk-chtheme qt4-qtconfig qt5-qtconfig scrot conky
